...
if (buisness == 3)
{
    printf ("Veuillez introduire le le type de buisness de formation (1 pour formation SEO, 2 pour formation développement personnel  ou 3 pour formation fitness : ");
    scanf ("%d",&type3);
    if (type3 == 1)
    {
